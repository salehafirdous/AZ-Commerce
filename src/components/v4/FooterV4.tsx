...
const FooterV4 = () => {
    const columns = [
        ...
        },
        {
            title: "Industries",
            links: [
                { name: "Grocery Stores", href: "/industries/grocery" },
                { name: "Restaurants", href: "/industries/restaurant" },
                { name: "Pharmacies", href: "/industries/pharmacy" },
                { name: "Retail Shops", href: "/industries/retail" },
                { name: "Distributors", href: "/industries/distributor" }
            ]
        },
        {
            title: "Resources",
