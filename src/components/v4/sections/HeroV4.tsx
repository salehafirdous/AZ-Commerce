                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div>
                        ...
                        >
                            <Link
                                href="/v4/signup"
                                className="px-8 py-4 bg-orange-600 text-white rounded-xl font-bold hover:bg-orange-700 transition-all shadow-xl shadow-orange-600/20 active:scale-95 flex items-center justify-center gap-3 group w-full sm:w-auto"
                            >
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                <div className="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-wider">Payment Received</div>
                                <div className="text-lg sm:text-xl font-bold text-slate-900">$2,450.00</div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div>
                                <div className="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-wider">Low Stock Alert</div>
                                <div className="text-xs sm:text-sm font-bold text-slate-900">5 items remaining</div>
                            </div>
                        </motion.div>
