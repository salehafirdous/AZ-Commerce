                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <div>
                            ...
                            >
                                Stop letting stock expire. Master perishable inventory, handle massive barcode catalogs, and launch a branded delivery app—all connected to a lightning-fast POS.
                            </motion.p>
