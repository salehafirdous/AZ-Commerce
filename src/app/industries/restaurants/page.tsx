...
import { ArrowRight, Utensils, QrCode, MonitorPlay, Mails, Play, CheckCircle2, ListChecks, Globe } from "lucide-react";
...
const features = [
    {
        ...
        desc: "Visualize your restaurant floor in real-time, handle splits and merges.",
        icon: Utensils,
        accent: "bg-orange-600"
    },
    {
        title: "Kitchen Display (KDS)",
        desc: "Send digital tickets directly to screens in the kitchen. Reduce lag and errors.",
        icon: MonitorPlay,
        accent: "bg-rose-600"
    },
    {
        title: "QR Code Ordering",
        desc: "Let guests scan, view digital menus, order, and pay directly from tables.",
        icon: QrCode,
        accent: "bg-emerald-600"
    },
    {
        title: "Recipe Costing",
        desc: "Track raw ingredients, map recipe yields, and calculate true meal margins.",
        icon: ListChecks,
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <div>
                            ...
                            >
                                Connect front-of-house, back-of-house, and delivery apps. Speed up table turns, reduce waste, and build loyalty with an all-in-one restaurant platform.
                            </motion.p>
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="mb-16">
                        <h2 className="text-3xl md:text-5xl font-display font-semibold text-[#0f172a] mb-6">
                            Appetite for <span className="text-orange-600 italic">Efficiency</span>
                        </h2>
                        <p className="text-xl text-slate-500 font-medium max-w-2xl">
                            From QSRs to Fine Dining, streamline every ticket and track ingredient-level profitability.
                        </p>
                    </div>
                        ...
                        {features.map((feature, i) => (
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-xl font-black text-[#0f172a] mb-3 group-hover:text-rose-600 transition-colors">
                                        {feature.title}
                                    </h3>
                    ...
                    <div className="bg-[#0f172a] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-4xl md:text-5xl font-display font-semibold text-white mb-6">
                                Start taking orders instantly
                            </h2>
                            <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto">
                                Equip your staff with tools they'll love and deliver faster service today.
                            </p>
                            <Link href="/v4/signup" className="inline-flex items-center gap-3 px-8 py-4 bg-orange-600 text-white rounded-xl font-bold hover:bg-rose-500 transition-colors">
